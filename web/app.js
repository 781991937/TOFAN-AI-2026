const I18N={ar:{academy:"الأكاديمية الذكية",heroTitle:"أكاديميتك الذكية للتعلّم المتدرّج",heroText:"منهج عالمي، معلّمون بالذكاء الاصطناعي، تقدّم محفوظ، واختبارات مرتبطة بمخرجات التعلّم.",login:"تسجيل الدخول",register:"إنشاء حساب",email:"البريد الإلكتروني",password:"كلمة المرور",name:"الاسم",logout:"تسجيل الخروج",learning:"التعلّم",specialties:"التخصصات",access:"الوصول",specialtyTitle:"مسارات التخصص",dynamic:"واجهة تتكيّف مع تخصصك",home:"الرئيسية",curriculum:"المنهج",progress:"التقدم",certificates:"الشهادات",profile:"الملف",notifications:"الإشعارات",refresh:"تحديث",back:"العودة",outcomes:"مخرجات التعلّم",prerequisites:"المتطلبات السابقة",units:"الوحدات",lessons:"الدروس",start:"فتح المقرر",noPrereq:"لا توجد متطلبات سابقة مسجلة.",noLessons:"لا توجد دروس مسجلة في هذه الوحدة.",courseType:"نوع المقرر",required:"إلزامي",elective:"اختياري",lessonContent:"محتوى الدرس متاح عبر المعلّم الذكي بعد بدء الخطوة التعليمية.",openTeacher:"بدء التعلّم مع المعلّم الذكي",openLesson:"فتح الدرس",lesson:"الدرس",teacher:"المعلّم الذكي",teacherReady:"المعلّم الذكي مرتبط بالمقرر ويمكن تشغيله من هنا.",freeSemester:"الفصل الأول من السنة الأولى مجاني",paidSemester:"هذا المحتوى ضمن الوصول المدفوع",teacherUnavailable:"المعلّم الذكي لهذا المقرر غير مفعّل بعد."},en:{academy:"Smart Academy",heroTitle:"Your intelligent academy for mastery-based learning",heroText:"Global knowledge, AI teachers, persistent progress, and assessments tied to learning outcomes.",login:"Sign in",register:"Create account",email:"Email",password:"Password",name:"Name",logout:"Sign out",learning:"Learning",specialties:"Specialties",access:"Access",specialtyTitle:"Specialty paths",dynamic:"An experience that adapts to your specialty",home:"Home",curriculum:"Curriculum",progress:"Progress",certificates:"Certificates",profile:"Profile",notifications:"Notifications",refresh:"Refresh",back:"Back",outcomes:"Learning outcomes",prerequisites:"Prerequisites",units:"Units",lessons:"Lessons",start:"Open course",noPrereq:"No prerequisites recorded.",noLessons:"No lessons are registered in this unit.",courseType:"Course type",required:"Required",elective:"Elective",lessonContent:"Lesson content is delivered through the smart teacher after the learning step begins.",openTeacher:"Start learning with the smart teacher",openLesson:"Open lesson",lesson:"Lesson",teacher:"AI Teacher",teacherReady:"The AI teacher is linked to this course and can be started here.",freeSemester:"Year 1 · Semester 1 is free",paidSemester:"This content is part of paid access",teacherUnavailable:"The AI teacher for this course is not active yet."}};
...
async function loadNotifications(){
  try{
    ...
    box.innerHTML=items.length?items.map(n=>"<article class='notification-item "+(n.is_read?"":"unread")+"'><div><b>"+esc(n.title||"")+"</b><p>"+esc(n.message||"")+"</p><small>"+esc(n.created_at||"")+"</small></div>"+(n.is_read?"":"<button class='ghost notification-read' data-id='"+esc(n.id)+"'>"+t("refresh")+"</button>")+"</article>").join(""):"<div class='detail-item'>"+(lang==="ar"?"لا توجد إشعارات.":"No notifications.")+"</div>";
