...
function showView(view){$$(".nav-btn").forEach(b=>b.classList.toggle("active",b.dataset.view===view));$("#coursePanel").classList.add("hidden");$("#lessonPanel").classList.add("hidden");if(view==="home"){$("#curriculumPanel").classList.add("hidden");return}if(view==="curriculum")openCurriculum();if(view==="progress")loadProgress();if(view==="certificates")loadCertificates();if(view==="profile")loadProfile()}
